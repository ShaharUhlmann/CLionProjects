#!/usr/bin/env python3
# taken from https://github.com/PSPDFKit-labs/clang-tidy-to-junit/blob/master/clang-tidy-to-junit.py
...
def print_convert(input_path):
    converter = ClangTidyConverter(input_path)
